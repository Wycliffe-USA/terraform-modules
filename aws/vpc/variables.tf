...
variable "name" {
  description = "Name to be used on all the resources as identifier.  Overrides app_name & app_env in some cases."
  type        = string
  default     = ""
}
...
variable "redshift_subnets" {
  description = "A map of maps contianing redshift subnets inside the VPC. Expected values are are cidr and az. Valid values also include name, and tags. Name overrides the default subnet naming."
  type        = map(any)
  default     = {}
}
...
variable "intra_subnets" {
  description = "A map of maps contianing intra subnets inside the VPC. Expected values are are cidr and az. Valid values also include name, and tags. Name overrides the default subnet naming."
  type        = map(any)
  default     = {}
}
